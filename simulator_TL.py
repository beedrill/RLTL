...
class Simulator():
    ...
    """
    def __init__(self, visual = False, map_file = 'map/traffic.net.xml', route_file = 'map/traffic.rou.xml', end_time = 3600, episode_time = 1000, additional_file = None, gui_setting_file = "map/view.settings.xml", config_file = None, penetration_rate = 1, record_file = "record.txt"):
        self.visual = visual
        ...
        self.tl_list = {}
        self.time = 0
        lane_list = [('n_0_0',251), ('e_0_0',251),('s_0_0',251),('w_0_0',251)] # temporary, in the future, get this from the .net.xml file
        # lane_list order: N, E, S, W
        self.lane_list = {l:Lane(l,self,length = d, penetration_rate=penetration_rate) for l,d in lane_list}
    ...
    def print_status(self):
        #print self.veh_list
        print 'current time:', self.time, ' total cars:', len(self.veh_list.keys()), 'traffic status', self.tl_list[self.tl_list.keys()[0]].traffic_state, 'reward:', self.tl_list[self.tl_list.keys()[0]].reward
...
class SimpleTrafficLight(TrafficLight):
    ...
    def updateRLParameters(self):
        lane_list = ['n_0_0', 'e_0_0','s_0_0','w_0_0']  # temporary, in the future, get this from the .net.xml file
        sim = self.simulator
        self.reward = 0
