...
python run_multiagents_rltl.py --load DQN_weights/Luxemburgh-26640-pen10/DQN_SUMO_4500000_weights --whole_day --mode test --phase_representation original --record --Luxembourg_intersection 26640
