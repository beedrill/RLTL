...
if __name__=="__main__":
    ...
    row = 3
    name = 'traffic'
    we_flow = [0.02,0.021,0.025,0.031,0.067,0.15,0.22,0.41,0.49,0.42,0.33,0.25,0.24,0.2,0.18,0.16,0.19,0.22,0.23,0.21,0.19,0.16,0.1,0.05]
    ns_flow = [0.019,0.02,0.03,0.029,0.061,0.12,0.15,0.19,0.21,0.18,0.18,0.16,0.15, 0.16,0.16,0.15,0.18,0.21,0.22,0.19,0.16,0.13,0.08,0.03]
    ew_flow = [0.021,0.023,0.033,0.04,0.066,0.13,0.14,0.25,0.24,0.19,0.17,0.17,0.16,0.18,0.22,0.21,0.31,0.43,0.55,0.42,0.32,0.19,0.11,0.04]
    sn_flow = [0.02,0.021,0.03,0.038,0.063,0.09,0.13,0.22,0.23,0.18,0.17,0.17,0.15, 0.17, 0.15,0.14,0.17,0.19,0.21,0.2,0.18,0.15,0.09,0.03]
