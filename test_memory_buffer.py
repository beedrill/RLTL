...
# memory
memory = ReplayMemory(max_size=20, window_length=5, state_input=(2,2))
...
# sample
for _ in range(10):
    batch_state, batch_action, batch_reward, batch_next_state, batch_terminal = memory.subsample(batch_size, stride=1)
